  ...
  <div class="modal fade" id="suggestions" tabindex="-1" role="dialog" aria-labelledby="Suggestions" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="alert alert-info" id="suggest-sending" style="display:none;">Sending, please wait...</div>
        <div class="alert alert-success" id="suggest-success" style="display:none;">Your message was sent!</div>
        <div class="alert alert-danger" id="suggest-errors" style="display:none;padding:0 5% 0 5%;"></div>
          <form action="{{ action('UserController@registerMessage') }}" accept-charset="UTF-8" id="suggest-form" role="form" method="POST">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="message" id="message" rows="3" placeholder="Enter your suggestion"></textarea>
            </div>
        </div>
